...
function PatientDetails() {
    ...
    useEffect(() => {
        const fetchPatients = async () => {
            try {
                ...
                const response = await axios.get('https://capstone-project-1-intc.onrender.com/patients');
    ...
    const handleUpdate = async () => {
        try {
            const response = await axios.put(`https://capstone-project-1-intc.onrender.com/patients/${editPatient._id}`, editedPatientData);
